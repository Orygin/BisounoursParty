<?php $tpl->includeTpl('header.html', false, Talus_TPL::INCLUDE_TPL); ?>
			<article>
				<header>
					<h2><a href="http://www.bisounoursparty.com/admin/"><?php echo $__tpl_vars__PAGE_TITLE; ?></a> > <a href="http://www.bisounoursparty.com/admin/devblog/">DevBlog</a> > <?php echo $__tpl_vars__LANG_ADMIN_EDIT; ?></h2>
				</header>
                                <article>
                                            <form action="/admin/devblog/updateArticle/<?php echo $__tpl_vars__ARTICLE_ID; ?>" method="post">
                                            ...
                                            <textarea name="content" rows="16" cols="80"><?php echo $__tpl_vars__ARTICLE_CONTENT; ?></textarea>
                                                   <select name="categorie" id="categorie">
                                                       <?php if ($tpl->block('menu_categories', null)) : $__tpl_6b68bcd011c1353109d7cf0e60096acc861ee962 = &$tpl->block('menu_categories', null); $__tpl_block_stack[] = 'menu_categories'; foreach ($__tpl_6b68bcd011c1353109d7cf0e60096acc861ee962 as &$__tplBlock['menu_categories']){ ?>
