<?php $tpl->includeTpl('header.html', false, Talus_TPL::INCLUDE_TPL); ?>
			<?php if ($tpl->block('articles', null)) : $__tpl_190a574a3fa412cd5974fb31bccd3e0ea7646ae8 = &$tpl->block('articles', null); $__tpl_block_stack[] = 'articles'; foreach ($__tpl_190a574a3fa412cd5974fb31bccd3e0ea7646ae8 as &$__tplBlock['articles']){ ?>
			<article>
				<header>
					<h2><a href="/<?php echo $__tpl_vars__LANG_URL_BLOG; ?>/<?php echo $__tpl_vars__LANG_URL_ARTICLE; ?>/<?php echo $__tplBlock['articles']['ARTICLE_ID']; ?>-<?php echo Talus_TPL_Filters::niceurl($__tplBlock['articles']['ARTICLE_TITLE']); ?>"><?php echo $__tplBlock['articles']['ARTICLE_TITLE']; ?></a></h2>
				</header>
				<article>
					<time>
				...
				<footer>
					<?php echo $__tpl_vars__LANG_BLOG_ARTICLE_AUTHOR; ?><a href="http://www.bisounoursparty.com/forum/profile.php?id=<?php echo $__tplBlock['articles']['ARTICLE_AUTHOR_ID']; ?>" class="author"><?php echo $__tplBlock['articles']['ARTICLE_AUTHOR_NICK']; ?></a><?php echo $__tpl_vars__LANG_BLOG_ARTICLE_CATEGORY; ?><a href="/<?php echo $__tpl_vars__LANG_URL_BLOG; ?>/<?php echo $__tpl_vars__LANG_URL_ARTICLE; ?>/<?php echo $__tplBlock['articles']['ARTICLE_CATEGORY_ID']; ?>-<?php echo Talus_TPL_Filters::niceurl($__tplBlock['articles']['ARTICLE_CATEGORY_NAME']); ?>"><?php echo $__tplBlock['articles']['ARTICLE_CATEGORY_NAME']; ?></a>
				</footer>
			</article>
			...
			<?php } unset($__tplBlock[array_pop($__tpl_block_stack)]); endif; ?>
             <?php if ($__tpl_vars__COMMENTS == 0) : ?>
	             <?php if ($__tpl_vars__BLOG_NUMBERPAGES != 1) : ?>
        		    <p>
			            <?php if ($tpl->block('pages', null)) : $__tpl_6d37d4c496842e5617c457b0e1129632a01501af = &$tpl->block('pages', null); $__tpl_block_stack[] = 'pages'; foreach ($__tpl_6d37d4c496842e5617c457b0e1129632a01501af as &$__tplBlock['pages']){ ?>
							<a href="/<?php echo $__tpl_vars__LANG_URL_BLOG; ?>/<?php echo $__tpl_vars__LANG_URL_ARTICLE; ?>/page-<?php echo $__tplBlock['pages']['NUM']; ?>"><?php echo $__tplBlock['pages']['NUM']; ?></a>
        	    		<?php } unset($__tplBlock[array_pop($__tpl_block_stack)]); endif; ?>
    		        </p>
	            <?php endif; ?>
            <?php endif; ?>
...
clickedIt=true;
                        ...
                        <article>
				<header>
					<h2><a href="/<?php echo $__tpl_vars__LANG_URL_BLOG; ?>/<?php echo $__tpl_vars__LANG_URL_ARTICLE; ?>/<?php echo $__tplBlock['articles']['ARTICLE_ID']; ?>-<?php echo Talus_TPL_Filters::niceurl($__tplBlock['articles']['ARTICLE_TITLE']); ?>"><?php echo $__tpl_vars__LANG_BLOG_COMMENTS; ?></a></h2>
				</header>
				<article>
			<?php if ($tpl->block('comments', null)) : $__tpl_888453efa047680c30e627af968a27a144665f67 = &$tpl->block('comments', null); $__tpl_block_stack[] = 'comments'; foreach ($__tpl_888453efa047680c30e627af968a27a144665f67 as &$__tplBlock['comments']){ ?>
					...
					<h4 class="medium red awesome"><?php echo $__tplBlock['comments']['COMMENT_AUTHOR_NICK']; ?></h4>
                            ...
                            <?php if ($__tpl_vars__USER_CAN_MODERATE == 1) : ?>
                                <a href="/<?php echo $__tpl_vars__LANG_URL_BLOG; ?>/DelComment/<?php echo $__tplBlock['comments']['COMMENT_ID']; ?>-<?php echo $__tplBlock['articles']['ARTICLE_ID']; ?>"><img src="/templates/img/delete.png" /></a>
                            ...
                            <article id="toggleText" style="display: none">
                                    ...
                                    <article>
                                        <?php if ($__tpl_vars__ISCONNECTED == 1) : ?>
                                            <form action="/<?php echo $__tpl_vars__LANG_URL_BLOG; ?>/AddComment/<?php echo $__tplBlock['articles']['ARTICLE_ID']; ?>-<?php echo Talus_TPL_Filters::niceurl($__tplBlock['articles']['ARTICLE_TITLE']); ?>" method="post">
