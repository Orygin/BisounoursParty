...
class CItem_FlechetteRounds : public CItem
{
public:
	DECLARE_CLASS( CItem_FlechetteRounds, CItem );

	void Precache( void )
	{
		PrecacheModel ("models/Weapons/flechette.mdl");
	}

	void Spawn( void )
	{ 
		Precache( );
		SetModel("models/Weapons/flechette.mdl");
		BaseClass::Spawn( );
	}

	bool MyTouch( CBasePlayer *pPlayer )
	{
		if (ITEM_GiveAmmo( pPlayer, SIZE_AMMO_FLECHETTE, "Flechette" ))
		{
			if ( g_pGameRules->ItemShouldRespawn( this ) == GR_ITEM_RESPAWN_NO )
			{
				UTIL_Remove(this);	
...
LINK_ENTITY_TO_CLASS(item_ammo_flechette, CItem_FlechetteRounds);
...
class CItem_Grenades : public CItem
{
public:
	DECLARE_CLASS( CItem_Grenades, CItem );

	void Precache( void )
	{
		PrecacheModel ("models/items/ammo_grenade.mdl");
	}

	void Spawn( void )
	{ 
		Precache( );
		SetModel( "models/items/ammo_grenade.mdl");
		BaseClass::Spawn( );
	}
...
LINK_ENTITY_TO_CLASS(item_ammo_grenade, CItem_Grenades);
// ========================================================================
//	>> AR2_Grenade
// ========================================================================
