// BISOUNOURS PARTY : ZOMBIES (GINGERBREAD AND CAREBEAR)
...
enum { ZOMBIE_EPICE, ZOMBIE_BISOU };
...
public:
	...
	bool CanBecomeLiveTorso() { return false; } //BP pas de découpage de zombie
	...
	virtual const char *GetTorsoModel( void ){ return "models/zombie/classic_torso.mdl"; }
	virtual const char *GetHeadcrabClassname( void ){ return "npc_headcrab"; }
	virtual const char *GetHeadcrabModel( void ){ return "models/headcrabclassic.mdl"; }
...
protected:
	...
	static const char *pMoanSoundsBisou[];
...
LINK_ENTITY_TO_CLASS( npc_gingerbread, CZombie );
LINK_ENTITY_TO_CLASS( npc_zombie_bisou, CZombie );
...
const char *CZombie::pMoanSoundsBisou[] =
{
	 "Zombie.Bisou.Moan1",
	 "Zombie.Bisou.Moan2",
	 "Zombie.Bisou.Moan3",
...
BEGIN_DATADESC( CZombie )
	...
	DEFINE_FIELD( m_iZombieType, FIELD_INTEGER ),
...
void CZombie::Precache( void )
{
	...
	if(m_iZombieType == ZOMBIE_BISOU){
		PrecacheModel( "models/zombie/bisounours.mdl" ); //BP Modèle du zombie bisounours

		PrecacheScriptSound( "Zombie.Bisou.FootstepRight" );
		PrecacheScriptSound( "Zombie.Bisou.FootstepLeft" );
		PrecacheScriptSound( "Zombie.Bisou.FootstepLeft" );
		PrecacheScriptSound( "Zombie.Bisou.ScuffRight" );
		PrecacheScriptSound( "Zombie.Bisou.ScuffLeft" );
		PrecacheScriptSound( "Zombie.Bisou.AttackHit" );
		PrecacheScriptSound( "Zombie.Bisou.AttackMiss" );
		PrecacheScriptSound( "Zombie.Bisou.Pain" );
		PrecacheScriptSound( "Zombie.Bisou.Die" );
		PrecacheScriptSound( "Zombie.Bisou.Alert" );
		PrecacheScriptSound( "Zombie.Bisou.Idle" );
		PrecacheScriptSound( "Zombie.Bisou.Attack" );

		PrecacheScriptSound( "Zombie.Bisou.Moan1" );
		PrecacheScriptSound( "Zombie.Bisou.Moan2" );
		PrecacheScriptSound( "Zombie.Bisou.Moan3" );
		PrecacheScriptSound( "Zombie.Bisou.Moan4" );
	}
	else{
		PrecacheModel( "models/zombie/classic.mdl" ); //BP Modèle du zombie pain d'épice
...
ConVar sk_zombie_bisou_health( "sk_zombie_bisou_health","150");
int CZombie::RandomSkin()
{
	int retour = m_nSkin;
...
void CZombie::FootstepSound( bool fRightFoot )
{
	if(m_iZombieType == ZOMBIE_BISOU){
		if(fRightFoot)
			EmitSound(  "Zombie.Bisou.FootstepRight" );
		else
			EmitSound(  "Zombie.Bisou.FootstepLeft" );
...
void CZombie::FootscuffSound( bool fRightFoot )
{
	if(m_iZombieType == ZOMBIE_BISOU){
		if(fRightFoot)
			EmitSound(  "Zombie.Bisou.ScuffRight" );
		else
			EmitSound(  "Zombie.Bisou.ScuffLeft" );
...
{
	if(m_iZombieType == ZOMBIE_BISOU)
		EmitSound( "Zombie.Bisou.AttackHit" );
	else
...
{
	if(m_iZombieType == ZOMBIE_BISOU)
		EmitSound( "Zombie.Bisou.AttackMiss" );
	else
...
{
	if(m_iZombieType == ZOMBIE_BISOU)
		return pMoanSoundsBisou[ nSound % ARRAYSIZE( pMoanSoundsBisou ) ];
	else
...
AI_BEGIN_CUSTOM_NPC( npc_gingerbread, CZombie )
