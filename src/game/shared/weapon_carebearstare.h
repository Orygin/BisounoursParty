#ifndef CAREBEARSTARE_H
#define CAREBEARSTARE_H
#pragma once
#include "cbase.h"
#ifdef CLIENT_DLL
...
#define CWeaponCarebearStare C_WeaponCarebearStare
#endif
...
private:
	...
	int				m_frameCount;
	friend class CWeaponCarebearStare;
};

class CWeaponCarebearStare : public CBaseHL2MPCombatWeapon
{
public:
	DECLARE_CLASS( CWeaponCarebearStare, CBaseHL2MPCombatWeapon );

	DECLARE_NETWORKCLASS(); 
	DECLARE_PREDICTABLE();


	CWeaponCarebearStare( void );
...
#define	NUM_GLOW_SPRITES ((CWeaponCarebearStare::PHYSCANNON_GLOW6-CWeaponCarebearStare::PHYSCANNON_GLOW1)+1)
#define NUM_ENDCAP_SPRITES ((CWeaponCarebearStare::PHYSCANNON_ENDCAP3-CWeaponCarebearStare::PHYSCANNON_ENDCAP1)+1)
...
protected:
	...
	CNetworkVar	(float, m_flLastFreezeTime); //BP
...
private:
	...
	CWeaponCarebearStare( const CWeaponCarebearStare & );
	DECLARE_ACTTABLE();
};
#endif