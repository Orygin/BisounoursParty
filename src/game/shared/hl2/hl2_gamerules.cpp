...
// Armes BP
ConVar	sk_plr_dmg_bat				( "sk_plr_dmg_bat", "0", FCVAR_REPLICATED );
ConVar	sk_plr_dmg_flower			( "sk_plr_dmg_flower", "0", FCVAR_REPLICATED );
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("Flechette",		DMG_BULLET,					TRACER_LINE,			"sk_plr_dmg_crossbow",		"sk_npc_dmg_crossbow",		"sk_max_crossbow",		BULLET_IMPULSE(800, 8000), 0 );
