...
// Functions to verify the single/multiplayer status of a game
	...
	//BP
	virtual int		GetForceFallDamage( void ) const { return m_iForceFallDamage; }
	virtual void	SetForceFallDamage( int falldamage ) { m_iForceFallDamage = falldamage; }
