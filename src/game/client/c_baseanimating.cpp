...
const float RAGDOLL_FADE_OUT_DELAY = 8.0f;
...
bool C_BaseAnimating::InitAsClientRagdoll( const matrix3x4_t *pDeltaBones0, const matrix3x4_t *pDeltaBones1, const matrix3x4_t *pCurrentBonePosition, float boneDt, int skin )
{
	CStudioHdr *hdr = GetModelPtr();
	...
	//BP On met le skin de bisounours mort (yeux en croix)
		//extern ConVar cl_skin;
	//int fskin = atoi(cl_skin.GetString());
	m_nSkin = skin +1;
