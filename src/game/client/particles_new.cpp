...
void CNewParticleEffect::Construct()
{
	...
	/*if(strcmp(this->GetName(),"gasgrenade_smoke") == 0)
	{
		C_BasePlayer *pPlayer = C_BasePlayer::GetLocalPlayer();
		if(pPlayer){
			Vector v;
			switch ((pPlayer->GetSkin()/2)+1){
				case 1: v = Vector(248,49,240); // rose
					break;
				case 2: v = Vector(0,252,0); // vert
					break;
				case 3: v = Vector(248,0,0); //rouge
					break;
				case 4: v = Vector(248,92,0);//orange
					break;
				case 5: v = Vector(120,147,248); //bleu
					break;
				case 6: v = Vector(165,0,248); //violet
					break;
				case 7: v = Vector(248,223,0); //jaune
					break;
				default: v = Vector(248,49,240);
					break;
				}
			v.NormalizeInPlace();
			this->SetControlPoint(3,v);
		}
	}*/ //BP SMOKE
