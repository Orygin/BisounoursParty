...
#elif defined( MP_SDK ) //BP LANG
	g_pVGuiLocalize->AddFile( "resource/bpr_%language%.txt", "GAME" );
...
void VGui_CreateGlobalPanels( void )
{
	...
	playpanel->Create( GameUiDll );
	AchievementsPanel->Create(GameUiDll);
	Updaterpanel->Create(GameUiDll);
	Privacypanel->Create(GameUiDll);
...
void VGui_Shutdown()
{
	...
	fps->Destroy();
	playpanel->Destroy();
	AchievementsPanel->Destroy();
	SMenu->Destroy();
	Privacypanel->Destroy();
	Updaterpanel->Destroy();
