...
protected:
	...
	CPanelAnimationVar(Color, m_TextColor, "TextColor", "ColorWhite");
	CPanelAnimationVar(Color, m_TextColor2, "TextColor2", "ColorWhite");

	CPanelAnimationVar(vgui::HFont, m_hNumberFont, "NumberFont", "HudNumbers");
	CPanelAnimationVar(vgui::HFont, m_hNumberOutlineFont, "NumberOutlineFont", "HudNumbersOutline");
