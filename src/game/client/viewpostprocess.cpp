...
// hdr parameters
ConVar mat_bloomscale( "mat_bloomscale", "0.5" );
...
ConVar mat_force_bloom("mat_force_bloom","1", FCVAR_CHEAT);
...
static ConVar mat_bloom_scalefactor_scalar( "mat_bloom_scalefactor_scalar", "0" );
