...
void CHL2MPClientScoreBoardDialog::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	...
	{
		m_pPlayerCountLabel_DM->SetFgColor( COLOR_WHITE );
		m_pScoreHeader_DM->SetFgColor( COLOR_WHITE );
		m_pDeathsHeader_DM->SetFgColor( COLOR_WHITE );
		m_pPingHeader_DM->SetFgColor( COLOR_WHITE );
		m_pPingLabel_DM->SetFgColor( COLOR_WHITE );
	}
	...
	{
		m_pPlayerCountLabel_R->SetFgColor( COLOR_GREEN );
		m_pScoreHeader_R->SetFgColor( COLOR_GREEN );
		m_pScoreLabel_R->SetFgColor( COLOR_GREEN );
		m_pDeathsHeader_R->SetFgColor( COLOR_GREEN );
		m_pPingHeader_R->SetFgColor( COLOR_GREEN );
		m_pPingLabel_R->SetFgColor( COLOR_GREEN );
	}
	...
	{
		m_pPlayerCountLabel_C->SetFgColor( COLOR_PINK );
		m_pScoreHeader_C->SetFgColor( COLOR_PINK );
		m_pScoreLabel_C->SetFgColor( COLOR_PINK );
		m_pDeathsHeader_C->SetFgColor( COLOR_PINK );
		m_pPingHeader_C->SetFgColor( COLOR_PINK );
		m_pPingLabel_C->SetFgColor( COLOR_PINK );
	}
...
void CHL2MPClientScoreBoardDialog::Reset()
{
	...
	InitPlayerList( m_pPlayerListR, TEAM_GREEN );
	InitPlayerList( m_pPlayerListC, TEAM_PINK );
}
...
void CHL2MPClientScoreBoardDialog::UpdateTeamInfo()
{
	...
	for ( int teamIndex = startTeam; teamIndex <= TEAM_GREEN; teamIndex++ )
	{
