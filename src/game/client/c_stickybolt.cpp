...
// Input  : &data - 
//-----------------------------------------------------------------------------
void StickyFlechetteCallback( const CEffectData &data )
{
	 StickRagdollNowFlechette( data.m_vOrigin, data.m_vNormal, data.m_nMaterial );
}

DECLARE_CLIENT_EFFECT( "FlechetteImpact", StickyFlechetteCallback );