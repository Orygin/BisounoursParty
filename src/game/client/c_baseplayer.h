...
public:
	...
	virtual bool	Init(int entnum, int serialnum);
	...
	virtual int		GetArmor() const { return m_iArmorValue; };
...
public:
	CNetworkVar( float, m_flJumpSoundAvoidTime ); // BP avoid jump sound repeating too often
	int m_StuckLast;
