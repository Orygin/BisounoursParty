...
//bp name
		...
		if ( !bSilent )
		{
			...
			if ( !IsInCommentaryMode() )
			{
				...
				{
					if(wszTeam == L"Pink")
						g_pVGuiLocalize->ConstructString( wszLocalized, sizeof( wszLocalized ), g_pVGuiLocalize->Find( "#game_player_joined_autoteam" ), 2, wszPlayerName, g_pVGuiLocalize->Find( "#TEAM_PINK" ) );
					else
						g_pVGuiLocalize->ConstructString( wszLocalized, sizeof( wszLocalized ), g_pVGuiLocalize->Find( "#game_player_joined_autoteam" ), 2, wszPlayerName, g_pVGuiLocalize->Find( "#TEAM_GREEN" ) );
				}
				else
				{
					if(wszTeam == L"Pink")
						g_pVGuiLocalize->ConstructString( wszLocalized, sizeof( wszLocalized ), g_pVGuiLocalize->Find( "#game_player_joined_team" ), 2, wszPlayerName, g_pVGuiLocalize->Find( "#TEAM_PINK" ) );
					else
						g_pVGuiLocalize->ConstructString( wszLocalized, sizeof( wszLocalized ), g_pVGuiLocalize->Find( "#game_player_joined_team" ), 2, wszPlayerName, g_pVGuiLocalize->Find( "#TEAM_GREEN" ) );
				}
